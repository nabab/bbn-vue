    ...
    methods: {
      ...
      component(type){
        return {
          ...
          template: this.edit ? bbnCmsBlockCreator.templates[type]['edit'] : bbnCmsBlockCreator.templates[type]['view'],
          data(){
            let tmp = Object.keys(bbnCmsBlockCreator.titleTemplates).map((a)=>{return a = {text:a, value:a}});
            return {
              //cp video
              muted: true,
              autoplay: false,
              ...
              borderStyle: bbnCmsBlockCreator.borderStyle,
          ...
          methods: {
            ...
            cpHTML(tag, type){
              return {
                props: ['source'],
                template: (type === 'title') ? bbnCmsBlockCreator.titleTemplates[tag] : bbnCmsBlockCreator.htmlTemplates[tag],
              }
            },
