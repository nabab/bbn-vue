    ...
    components: {
      ...
      'bbn-tree-node': {
        ...
        methods: {
          ...
          getCls(item) {
            let cls = item.cls ? item.cls : (this.tree.cls ? this.tree.cls : '');
            if (cls) {
              cls = bbn.fn.isFunction(cls) ? cls(item, this.tree, this.parent) : cls;
            }
            return cls;
          }
        },
