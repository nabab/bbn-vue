(bbn => {
  ...
  bbn.fn.autoExtend("vue", {
    /**
     * Initializes bbn and creates the main Vue app
     * 
     * @param {[String, HTMLElement]} ele selector 
     * @param {Object} cfg bbn configuration
     * @param {Object} app Vue object
     * @param {Array} mixins 
     */
    init: (ele, cfg = {}, app = {}, mixins = []) => {
      if ( !bbn.vue ){
      ...
      bbn.vue.app.config.unwrapInjectedRef = true;
