...
if(title&&(title!==this.currentTitle)){bbn.fn.log("CHANGIN URL",this.currentTitle,title)
...
return paneId;},selectPaneTab(pane){bbn.fn.log(pane);},closeTab(idx){this.close(this.tabsList[idx].idx);},removePane(paneId){if(this.splittable){let paneIndex=bbn.fn.search(this.currentPanes,{id:paneId});let pane=this.currentPanes[paneIndex];if(!pane){throw new Error(bbn._("Impossible to find the pane with ID %s",paneId));}
