...
if(a.selected!==i){bbn.fn.log("CHAINGING BY ROUTRE",url);a.selected=i;ok=false;return false;}}})
if(!ok){return false;}});}
...
if(this.urls[st].currentView.pane){let pane=bbn.fn.getRow(this.currentPanes,{id:this.urls[st].currentView.pane});if(pane){let idx=bbn.fn.search(pane.tabs,{url:st});if(pane.tabs[idx]&&(pane.selected===idx)){this.activate(url,this.urls[st]);}}}
