...
else if(res&&(this.selected===idx)){if(this.views.length){let newIdx=false;bbn.fn.each(this.history,a=>{bbn.fn.log("HISTORY",a);let tmp=this.getIndex(a);if(tmp!==false){newIdx=tmp;return false;}});if(newIdx===false){while(idx>=0){if(this.views[idx]){newIdx=idx;break;}
idx--;}}
