...
else{obj.content=`<div class="bbn-spadded">${data.text}</div>`;}
...
this.$forceUpdate();}}},created(){this.componentClass.push('bbn-resize-emitter');if(this.$slots.default){for(let node of this.$slots.default){if(node.componentOptions&&(node.componentOptions.tag==='bbns-column')){this.addColumn(node.componentOptions.propsData);}
