...
let value=!!format&&!!val?(moment(val.toString(),format).isValid()?moment(val.toString(),format).format(format):''):'';if(value){if(this.min&&(value<this.min)){value=this.min;}
...
if(!bbn.fn.isNull(this.second)&&ss){ss.onResize();ss.scrollTo(0,this.getRef('secondActive'));}},400)})}}}}}});})(bbn);if(bbn_resolve){bbn_resolve("ok");}};document.head.insertAdjacentElement("beforeend",script_dep);})(bbn);}