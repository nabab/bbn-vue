...
else{let ct=this.getRef('scrollContainer');if(ct&&(y+ct.clientHeight>=ct.scrollHeight)){this.$emit('reachBottom');}}}}});})(bbn);if(bbn_resolve){bbn_resolve("ok");}})(bbn);}