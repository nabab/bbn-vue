...
this.setScrollDelay();}}
if(this.scrollable&&e){e.stopImmediatePropagation();}},setScrollDelay(){clearTimeout(this.scrollTimeout);this.scrollTimeout=setTimeout(()=>{this.afterScroll();},this.scrollInitial.touched==='finished'?100:500);},afterScroll(){if(this.fullPage&&this.scrollInitial){if(this.hasScrollX&&(this.currentX!==this.scrollInitial.x)){let r1=this.scrollInitial.x?Math.round(this.scrollInitial.x / this.containerWidth):0;let r2=this.currentX?Math.round(this.currentX / this.containerWidth):0;let left;if(r1!==r2){left=r2*this.containerWidth;}
...
if(bbn.fn.isNumber(top)&&(top!==this.currentY)){this.$refs.yScroller.scrollTo(top,true);}}
