...
else{this.$el.querySelector("div.editor-toolbar").display='none'}}},watch:{disabled(newVal){this.disableWidget(newVal);},readonly(newVal){this.readonlyWidget(newVal);}},mounted(){const vm=this;this.widget=new EasyMDE(bbn.fn.extend({element:this.$refs.element},{}));this.widget.codemirror.on("change",()=>{this.emitInput(this.widget.value());});if(this.disabled){this.disableWidget(true);}
