...
else if(bbn.fn.isString(props.size)){if(bbn.fn.substr(props.size,-1)==='%'){isPercent=true;isRelative=true;unit='%';}
else{switch(bbn.fn.substr(props.size,-2)){case'px':isNumber=true;props.size=parseInt(props.size);unit='px';break;case'fr':case'em':isRelative=true;unit=bbn.fn.substr(props.size,-2);break;}}}
