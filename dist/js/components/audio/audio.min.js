...
return false;}},methods:{play(){this.widget.play();},pause(){this.widget.pause();},onPlay(ev){this.$emit('play',ev,this);},onPause(ev){this.$emit('pause',ev,this);},},mounted(){this.widget=this.getRef('audio');}});})(bbn);if(bbn_resolve){bbn_resolve("ok");}})(bbn);}