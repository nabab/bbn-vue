...
if(this.$parent.edit){if((this.source.type==='image')&&this.source.content&&this.source.content.length){let extension=this.source.content.substr(this.source.content.lastIndexOf('.'),this.source.content.length)
