...
`;script.setAttribute('id','bbn-tpl-component-list-input');script.setAttribute('type','text/x-template');document.body.insertAdjacentElement('beforeend',script);let css=document.createElement('link');css.setAttribute('rel','stylesheet');css.setAttribute('href',bbn.vue.libURL+'dist/js/components/list-input/list-input.css');document.head.insertAdjacentElement('beforeend',css);(function(Vue,bbn){"use strict";let isClicked=false;Vue.component('bbn-list-input',{mixins:[bbn.vue.basicComponent,bbn.vue.listComponent,bbn.vue.keynavComponent,bbn.vue.inputComponent],props:{unique:{type:Boolean,default:true},mode:{type:String,default:"free"},suggest:{type:Boolean,default:false}},data(){return{};},computed:{},methods:{},mounted(){}});})(window.Vue,window.bbn);if(bbn_resolve){bbn_resolve("ok");}})(bbn);}