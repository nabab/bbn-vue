...
else{this.readyForm=false;this.isValidated=false;}},50)},onSuccess(){bbn.fn.log("SUCCESS",arguments,this.data)}},watch:{currentSelected(){this.isValidated=false;this.updateButtons();},readyForm(v){this.updateButtons();},data:{deep:true,handler(){this.updateButtons();}}}});})(bbn);if(bbn_resolve){bbn_resolve("ok");}})(bbn);}