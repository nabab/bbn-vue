...
this.sortTargetIndex=null;}},created(){this.init();this.setCurrentSlots();},mounted(){this.ready=true;this.onResize();this.$watch('currentSlots',(newVal,oldVal)=>{if(!bbn.fn.isSame(newVal,oldVal)){this.init();}});},updated(){},watch:{sortTargetIndex(newVal){},isSorting(newVal){if(!newVal){}},source:{deep:true,handler(){this.init();}}}});})(bbn);if(bbn_resolve){bbn_resolve("ok");}})(bbn);}