...
script.innerHTML = `<div :class="['bbn-overlay' , componentClass, {'bbn-unselectable': isSorting}]"
...
`;
script.setAttribute('id', 'bbn-tpl-component-dashboard');
script.setAttribute('type', 'text/x-template');
document.body.insertAdjacentElement('beforeend', script);
let css = document.createElement('style');
css.innerHTML = `.bbn-dashboard.bbn-unselectable {
  cursor: move;
}
...
.bbn-dashboard .bbn-dashboard-sortable .bbn-widget-placeholder {
  min-height: 200px;
}
`;
