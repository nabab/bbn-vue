(bbn_resolve)=>{((bbn)=>{let script=document.createElement('script');script.innerHTML=`<span :class="componentClass">
...
`;script.setAttribute('id','bbn-tpl-component-loadicon');script.setAttribute('type','text/x-template');document.body.insertAdjacentElement('beforeend',script);(function(bbn){"use strict";Vue.component('bbn-loadicon',{mixins:[bbn.vue.basicComponent],props:{size:{type:[Number,String],default:16},},computed:{currentSize(){return bbn.fn.formatSize(this.size);}}});})(bbn);if(bbn_resolve){bbn_resolve("ok");}})(bbn);}