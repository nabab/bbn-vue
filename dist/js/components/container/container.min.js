...
if(this.isComponent){let cont=this;let o=bbn.fn.extend(true,res?res:{},{template:'<div class="'+(this.scrollable?'':'bbn-w-100')+'">'+this.content+'</div>',methods:{getContainer(){if(!this._bbn_container){this._bbn_container=this.closest('bbn-container');}
