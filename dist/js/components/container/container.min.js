...
this.currentIndex=v;},current(newVal){if(newVal.indexOf(this.url)===0){this.currentURL=newVal;}},currentURL(newVal,oldVal){if(!newVal||(newVal.indexOf(this.url)!==0)){this.currentURL=this.url;}
else if(this.currentView&&(this.currentView.current!==newVal)){this.router.route(newVal)}},ready(v){if(v){if(this.onMount){this.onMount(this.$el,this.source);}}},isVisible(nv){let emit=true;if(!this.isPane&&this.router.isVisual){if(nv){this.setScreenshot()}
