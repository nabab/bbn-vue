...
</span>`;script.setAttribute('id','bbn-tpl-component-icon');script.setAttribute('type','text/x-template');document.body.insertAdjacentElement('beforeend',script);(function(){"use strict";Vue.component('bbn-icon',{name:'bbn-icon',mixins:[bbn.vue.basicComponent],data(){return{content:'',isLoading:true,isNotFound:false}}})})();if(bbn_resolve){bbn_resolve("ok");}})(bbn);}