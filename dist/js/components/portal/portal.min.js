...
this.container=new TargetContainer({el,parent:this,propsData:{tag:this.tag,nodes:this.$scopedSlots.default,},});}
else{this.unmount()}},unmount(){if(this.container){this.container.$destroy();delete this.container;}},},});})(bbn);if(bbn_resolve){bbn_resolve("ok");}})(bbn);}