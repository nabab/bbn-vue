...
>
  <div v-if="renderedContent" v-html="renderedContent"></div>
</component>`;script.setAttribute('id','bbn-tpl-component-field');script.setAttribute('type','text/x-template');document.body.insertAdjacentElement('beforeend',script);let css=document.createElement('link');css.setAttribute('rel',"stylesheet");css.setAttribute('href',bbn.vue.libURL+"dist/js/components/field/field.css");document.head.insertAdjacentElement('beforeend',css);((bbn)=>{"use strict";Vue.component('bbn-field',{mixins:[bbn.vue.basicComponent,bbn.vue.fieldComponent,bbn.vue.dataComponent],props:{value:{},mode:{type:String,default:'read'},},data(){return{renderedComponent:false,renderedContent:'',renderedOptions:bbn.fn.extend({},this.options),currentValue:this.value}},computed:{actualData(){if(this.data){return this.data;}
