...
return'';},getMenuFn(idx){if(this.router){return this.router.getMenuFn(idx);}}},watch:{},mounted(){this.router=this.closest('bbn-router');this.ready=true;}});})(bbn);if(bbn_resolve){bbn_resolve("ok");}})(bbn);}