...
return false;},closePopup(window,ev){if(this.window&&this.$el&&!this.isClosing){this.isClosing=true;if(!this.isPosted&&this.confirmLeave&&this.isModified()){if(ev){ev.preventDefault();}
