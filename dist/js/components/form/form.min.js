...
this.canSubmit=this._canSubmit();this.isInit=true;});},checkValidity(){return this.$el.checkValidity();},reportValidity(){return this.$el.reportValidity();}},mounted(){let container=this;while(container=container.closest('bbn-container')){container.forms.push(this);}
