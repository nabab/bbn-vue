...
this.dirty=false;this.isLoading=false;if(!e.defaultPrevented){if(this.window){this.window.close();}}}},_execCommand(button,ev){if(button.action){button.action(this.source,this,ev)}},updateButtons(){if(this.buttons===false){return;}
