...
</div>`;script.setAttribute('id','bbn-tpl-component-window');script.setAttribute('type','text/x-template');document.body.insertAdjacentElement('beforeend',script);let css=document.createElement('link');css.setAttribute('rel','stylesheet');css.setAttribute('href',bbn.vue.libURL+'dist/js/components/window/window.css');document.head.insertAdjacentElement('beforeend',css);(function(bbn){"use strict";Vue.component('bbn-window',{name:'bbn-window',mixins:[bbn.vue.basicComponent,bbn.vue.resizerComponent,bbn.vue.dimensionsComponent],props:{maximizable:{type:Boolean,default:true},closable:{type:Boolean,default:true},scrollable:{type:Boolean,default:true},draggable:{type:Boolean,default:false},resizable:{type:Boolean,default:true},maximized:{type:Boolean,default:false},onOpen:{type:Function},beforeClose:{type:Function},onClose:{type:Function},afterClose:{type:Function},footer:{type:[Function,String,Object]},buttons:{type:Array,default(){return[];}},source:{type:Object,default(){return{};}},component:{type:[String,Function,Object]},title:{type:[String,Boolean],default:bbn._("Untitled")},uid:{type:String},content:{type:String},mode:{type:String}},data(){let fns=[];if(this.onClose){fns.push(this.onClose);}
