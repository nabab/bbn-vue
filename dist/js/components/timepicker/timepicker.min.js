...
this.ready=true;},watch:{min(){this.setValue(this.value||'');},max(){this.setValue(this.value||'');},valueFormat(){this.setValue(this.value||'');},maskedMounted(newVal){if(newVal){this.setInputValue(this.value);}},value(newVal){this.setInputValue(newVal);}}});})(bbn);if(bbn_resolve){bbn_resolve("ok");}})(bbn);}