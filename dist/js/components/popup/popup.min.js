...
if(d.url){return this.post(d.url,d.data||{},(r)=>{if(r.content||r.title){if(r.script){let tmp=eval(r.script);if(bbn.fn.isFunction(tmp)){d.open=tmp;}
...
btn.closest('bbn-floater').close(true);}}];this.open(bbn.fn.extend(o,{maximizable:false,scrollable:true,resizable:false}));}},confirm(){let onYes=false,onNo=false,yesText=bbn._('Yes'),noText=bbn._('No'),o={},has_msg=false,has_yes=false,has_width=false,i;if(bbn.fn.isObject(arguments[0])){o=arguments[0];}
