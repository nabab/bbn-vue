...
else if(!ev.target.classList.contains('bbn-gallery-button-menu')&&(!ev.target.closest('.bbn-floater-list'))&&this.col.gallery.zoomable){bbn.fn.log("ACTION 2");this.getPopup({title:bbn._('Gallery'),width:'100%',height:'100%',scrollable:false,resizable:false,maximizable:false,component:this.col.gallery.$options.components.galleryZoom,source:{data:bbn.fn.map(this.col.gallery.currentData,d=>{let obj=bbn.fn.extend(true,{},d.data);obj.content=obj[this.col.gallery.pathName];obj.type='img';obj.mode='original';if(!obj.info){obj.info=obj[this.col.gallery.overlayName];}
