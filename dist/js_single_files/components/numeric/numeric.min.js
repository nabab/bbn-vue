...
this.keydown(e);},_focus(e){if(!this.disabled&&!this.readonly&&!this.onlySpinners){this.currentValue=this.value;this.editMode=true;this.$nextTick(()=>{this.focus(e);this.selectText();})}},_blur(e){this.checkMinMax();this.checkDecimals();this.editMode=false;this.$nextTick(()=>{this.blur(e);})},checkDecimals(){if(this.currentDecimals&&this.currentValue&&parseFloat(this.currentValue).toString().match('^\-?[0-9]+\.0{0,'+this.currentDecimals+'}[1-9]{0}$')){this.currentValue=parseFloat(this.currentValue).toFixed(0);}},checkMinMax(){let w=false;if(bbn.fn.isNumber(this.max)&&(this.currentValue!=='')&&(this.currentValue!==null)&&(parseFloat(this.currentValue)>parseFloat(this.max))){this.currentValue=parseFloat(this.max).toFixed(this.currentDecimals);w=true;}
