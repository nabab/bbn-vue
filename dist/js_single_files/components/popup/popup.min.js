...
return false;}},created(){this.componentClass.push('bbn-resize-emitter');},mounted(){this.onResize();bbn.fn.each(this.popups,a=>this.open(a));},watch:{items(){this.makeWindows();},numPopups(v){if(v&&!this.ready){this.ready=true;}}}});})(bbn);})(bbn);