...
return this.max;},currentStep(){if(this.currentUnit){return bbn.fn.getField(this.units,'step','value',this.currentUnit);}
return this.step;},currentDecimals(){if(this.currentUnit){return bbn.fn.getField(this.units,'decimals','value',this.currentUnit)||0;}
