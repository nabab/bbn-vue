...
</div>`;script.setAttribute('id','bbn-tpl-component-cms-block');script.setAttribute('type','text/x-template');document.body.insertAdjacentElement('beforeend',script);(function(bbn){"use strict";let titleTemplates={h1:`<h1 v-text="source.content"></h1>`,h2:`<h2 v-text="source.content"></h2>`,h3:`<h3 v-text="source.content"></h3>`,h4:`<h4 v-text="source.content"></h4>`,h5:`<h5 v-text="source.content"></h5>`,},htmlTemplates={p:`<p v-html="source.content"></p>`,span:`<span v-html="source.content"></span>`},templates={text:{view:`<div v-html="source.content || '&nbsp;'"/>`,edit:`<bbn-textarea class="bbn-w-100"
...
bbn.fn.log("I AM THE BLOCK! ",this.source);},watch: {changed(){bbn.fn.log("changed")},type(){bbn.fn.log("type")},edit(val){}},});})(bbn);})(bbn);