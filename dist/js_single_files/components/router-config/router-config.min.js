...
`;Vue.component("bbn-router-config",{mixins:[bbn.vue.basicComponent,bbn.vue.localStorageComponent,],props:{router:{type:Vue,required:true}},data(){return{svg:img,visualSelected:2,breadcrumbSelected:2,tabsSelected:2,breadcrumbActive:false,visualShowAll:false,};},computed:{orientations(){let tmp={auto:{text:bbn._("Picks left or top in function of your wiondow's size"),value:false},left:{text:bbn._("On the left of the main content"),area:'1 / 2 / 6 / 6',value:false},top:{text:bbn._("On the top of the main content"),area:'2 / 1 / 6 / 6',value:false},right:{text:bbn._("On the right of the main content"),area:'1 / 1 / 6 / 5',value:false},bottom:{text:bbn._("On the bottom of the main content"),area:'1 / 1 / 5 / 6',value:false}};tmp.auto.area=tmp[this.guessedOrientation].area;return tmp;},mode:{get(){if(this.router.isVisual){return'visual';}
