...
if(this.selectUrl){bbn.fn.post(this.selectUrl,{data:item,},d=>{bbn.fn.log("RESULT OF SELECT URL",d);})}
this.filterString='';}}},keydown(e){if((e.key===' ')||this.commonKeydown(e)){return;}
if(e.key==='Escape'){this.resetDropdown();}
else if(bbn.var.keys.upDown.includes(e.keyCode)){this.keynav(e);}},},watch:{filteredTotal(v,ov){if(v&&!ov){this.isOpened=true;}
else if(!v&&ov){this.isOpened=false;}},filterString(v){if(!this.ready){this.ready=true;}
