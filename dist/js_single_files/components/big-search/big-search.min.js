...
this.isOpened=false;this.filterString='';}}},keydown(e){if(e.key==='Enter'){let list=this.getRef('list');if(list&&bbn.fn.isNumber(list.overIdx)){list.select(list.overIdx);}}
...
else{this.unfilter();}},this.delay);})}}},mounted(){this.ready=true;}});})(bbn,Vue);})(bbn);