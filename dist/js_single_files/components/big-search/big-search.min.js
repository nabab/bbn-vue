((bbn)=>{let script=document.createElement('script');script.innerHTML=`<div :class="[componentClass, 'bbn-overlay', 'bbn-flex-height']">
...
else if(bbn.var.keys.upDown.includes(e.keyCode)){this.keynav(e);}},},watch:{isOpened(v){bbn.fn.log("isOpened",this.isOpened);if(!v){this.$emit('close');}},filterString(v){if(!this.ready){this.ready=true;}
