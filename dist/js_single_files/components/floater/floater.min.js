...
else{let popup=this.closest('bbn-popup');if(popup&&this.uid){let idx=popup.getIndexByUID(this.uid);popup.close(idx,true);}
else{this.hide();}}},closeAll(){if(this.level){let ancestors=this.ancestors('bbn-floater');for(let i=this.level;i>=0;i--){if(ancestors[i]){ancestors[i].close(true);}}}
