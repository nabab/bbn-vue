...
return new Promise(resolve=>{setTimeout(()=>{resolve();},0);});},realResize(){return this.keepCool(()=>{let p;let go=this.isVisible&&this.scrollReady&&bbn.fn.isDom(this.$el)&&this.isActiveResizer()&&(!this.isResizing||!this.isResized);if(go){this.isResizing=true;this._setMinMax();}
