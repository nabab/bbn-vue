...
if(this.forms.length&&!confirm){this.forms[0].closePopup(force);}
...
this.$emit('open',this);}
else if(this.onClose){this.onClose(this);}},scrollReady(v){if(v){this.realResize();}},element(newVal){if(newVal&&this.ready){this.currentVisible=false;this.$forceUpdate();this.$nextTick(()=>{this.currentVisible=true;});}},isOver(v){if(this.autoHide&&this.isResized&&this.ready&&!this.isResizing){if(v&&this.mouseLeaveTimeout){clearTimeout(this.mouseLeaveTimeout);}
