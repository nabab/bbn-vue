...
`;script.setAttribute('id','bbn-tpl-component-floater');script.setAttribute('type','text/x-template');document.body.insertAdjacentElement('beforeend',script);(function(Vue,bbn){"use strict";let isClicked=false;Vue.component('bbn-floater',{name:'bbn-floater',mixins:[bbn.vue.basicComponent,bbn.vue.listComponent,bbn.vue.componentInsideComponent,bbn.vue.dimensionsComponent,bbn.vue.resizerComponent,bbn.vue.keepCoolComponent,bbn.vue.toggleComponent,bbn.vue.positionComponent],props:{container:{},position:{type:String,validator:p=>['','topLeft','topRight','bottomLeft','bottomRight','top','bottom','left','right'].includes(p)},content:{type:String,default:''},css:{type:String},options:{type:Object},element:{type:Element},elementWidth:{type:Boolean,default:true},orientation:{type:String,default:'vertical',validator:o=>['vertical','horizontal'].includes(o)},scrollable:{type:Boolean,default:true},axis:{type:String,default:"both"},visible:{type:Boolean,default:true},mode:{type:String,default:"free",validator:m=>['free','options','selection'].includes(m)},level:{type:Number,default:0},itemComponent:{type:Object,default(){return{};},},autoHide:{type:[Number,Boolean],default:false},title:{type:[Boolean,String]},footer:{type:[Function,String,Object]},buttons:{type:Array,default(){return[];}},closable:{type:Boolean,default:false},maximizable:{type:Boolean,default:false},animation:{type:Boolean,default:false},latency:{type:Number,default:50},onOpen:{type:Function},onSelect:{type:Function},beforeClose:{type:Function},onClose:{type:Function},afterClose:{type:Function},index:{type:Number},uid:{type:String},suggest:{type:[Boolean,Number],default:false},opener:{type:Vue},actionArguments:{type:Array}},data(){let fns=[];if(this.onClose){fns.push(this.onClose);}
