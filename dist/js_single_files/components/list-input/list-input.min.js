...
`;script.setAttribute('id','bbn-tpl-component-list-input');script.setAttribute('type','text/x-template');document.body.insertAdjacentElement('beforeend',script);(function(Vue,bbn){"use strict";let isClicked=false;Vue.component('bbn-list-input',{mixins:[bbn.vue.basicComponent,bbn.vue.listComponent,bbn.vue.keynavComponent,bbn.vue.inputComponent],props:{unique:{type:Boolean,default:true},mode:{type:String,default:"free"},suggest:{type:Boolean,default:false}},data(){return{};},computed:{},methods:{},mounted(){}});})(window.Vue,window.bbn);})(bbn);