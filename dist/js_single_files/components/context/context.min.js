...
this.toggle();}}},clickOut(e){if(!e.target.closest('.bbn-floater-context-'+this.bbnUid)){this.showFloater=false;}},toggle(){if(!this.showFloater){this.updateData().then(()=>{this.showFloater=!this.showFloater;});}
