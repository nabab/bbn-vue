((bbn)=>{let script_dep=document.createElement('script');script_dep.setAttribute('src',"https://cdn.jsdelivr.net/combine/gh/apexcharts/apexcharts.js@v3.19.2/dist/apexcharts.min.js,gh/moment/moment@2.27.0/min/moment-with-locales.min.js");script_dep.onload=()=>{let css_dependency;css_dependency=document.createElement('link');css_dependency.setAttribute('rel',"stylesheet");css_dependency.setAttribute('href',"https://cdn.jsdelivr.net/combine/gh/apexcharts/apexcharts.js@v3.19.2/dist/apexcharts.css");document.head.insertAdjacentElement('beforeend',css_dependency);let script=document.createElement('script');script.innerHTML=`<div :class="['bbn-flex-height', componentClass]"
     :style="{
       width: width,
       height: height
     }"
...
if(this.xDate){cfg.xaxis.type='datetime';if(bbn.fn.isString(this.xDate)){cfg.xaxis.labels.formatter=(value,timestamp,index)=>{return moment(timestamp).format(this.xDate);}}}
...
return cfg;}
return{};},radialCfg(){let cfg={chart:{type:'radialBar'},plotOptions:{radialBar:{dataLabels:{total:{show:true,total:bbn._('TOTAL')}}}}}
