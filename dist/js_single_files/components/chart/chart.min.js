((bbn)=>{let script_dep=document.createElement('script');script_dep.setAttribute('src','https://cdn.jsdelivr.net/combine/gh/apexcharts/apexcharts.js@v3.19.2/dist/apexcharts.min.js');script_dep.onload=()=>{let css_dependency;css_dependency=document.createElement('link');css_dependency.setAttribute('rel','stylesheet');css_dependency.setAttribute('href','https://cdn.jsdelivr.net/combine/gh/apexcharts/apexcharts.js@v3.19.2/dist/apexcharts.css');document.head.insertAdjacentElement('beforeend',css_dependency);let script=document.createElement('script');script.innerHTML=`<div :class="['bbn-flex-height', componentClass]"
     :style="{
       width: width,
       height: height
     }"
...
else{this.updateWidget();}}}}},mounted(){this.container=this.getRef('container');this.$nextTick(()=>{this.ready=true;})}});})(bbn);};document.head.insertAdjacentElement("beforeend",script_dep);})(bbn);