...
default:return'nf nf-fa-file'}},getFileExt(file){return file.fromUser?file.data.name.substring(file.data.name.lastIndexOf('.')+1):bbn.fn.substr(file.data.extension,1)}},mounted(){this.$nextTick(()=>{if(this.value){this._makeFiles(this.getValue(),false,'success')}
