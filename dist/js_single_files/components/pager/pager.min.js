((bbn)=>{let script=document.createElement('script');script.innerHTML=`<div v-if="ready && (numPages || extraControls)"
...
this.numericTimeout=setTimeout(()=>{if(this.currentPage!==v){this.currentPage=v;}},500);}}});})(bbn);})(bbn);