((bbn)=>{let script=document.createElement('script');script.innerHTML=`<div :class="componentClass">
  ...
  <input type="hidden"
         ...
         ref="element"
         :name="name">
</div>`;script.setAttribute('id','bbn-tpl-component-wheel');script.setAttribute('type','text/x-template');document.body.insertAdjacentElement('beforeend',script);(function(bbn){"use strict";Vue.component('bbn-wheel',{mixins:[bbn.vue.basicComponent,bbn.vue.inputComponent,bbn.vue.listComponent],data(){return{scrollReady:false,barElement:undefined,isScrolling:false}},computed:{isReady(){return this.scrollReady&&this.isLoaded;},upButtonDisabled(){if(this.isNull(this.value)){return false;}
