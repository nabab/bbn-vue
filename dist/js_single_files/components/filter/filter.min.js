((bbn)=>{let script=document.createElement('script');script.innerHTML=`<div :class="componentClass" :style="'border-left-color:' + border_color">
  <h3 v-if="first"
...
</div>`;script.setAttribute('id','bbn-tpl-component-filter');script.setAttribute('type','text/x-template');document.body.insertAdjacentElement('beforeend',script);(function(bbn){"use strict";const
