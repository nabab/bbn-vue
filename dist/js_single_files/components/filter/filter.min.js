...
`;script.setAttribute('id','bbn-tpl-component-filter');script.setAttribute('type','text/x-template');document.body.insertAdjacentElement('beforeend',script);(function(bbn){"use strict";const
