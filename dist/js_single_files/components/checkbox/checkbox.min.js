...
return this.checked;},},methods:{toggle(){if(!this.isDisabled&&!this.readonly){let emitVal=!this.state?this.valueToSet:this.novalue;this.$emit('input',emitVal);this.$emit('change',emitVal,this);}},onClick(ev){if(this.isDisabled||this.readonly){ev.preventDefault();}
else{this.click(ev);}},onKeyDown(ev){if((this.isDisabled||this.readonly)&&(ev.keyCode===32)){ev.preventDefault()}
...
if(!this.checked&&!this.state){}}});})(bbn);})(bbn);