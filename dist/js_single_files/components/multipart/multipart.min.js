...
else{this.readyForm=false;}})},onSuccess(){bbn.fn.log("SUCCESS",arguments,this.data)}},watch:{currentSelected(){this.updateButtons();},readyForm(v){this.updateButtons();},data:{deep:true,handler(){this.updateButtons();}}}});})(bbn);})(bbn);