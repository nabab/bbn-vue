...
else{this.alert(bbn._("Impossible to save the chat's title"));}})}},toggleAdmin(idUser){let idx=this.admins.indexOf(idUser);if(idx===-1){this.addAdmin(idUser)}
