...
if(!e.defaultPrevented){this.tree.$emit('beforeLoad',this.getPostData());}});this.$on('startloading',()=>{this.loading=true;});this.$on('dataReceived',d=>{this.loading=false;this.$emit('load',d);});if(bbn.fn.isFunction(this.source)){this.isFunction=true;}
