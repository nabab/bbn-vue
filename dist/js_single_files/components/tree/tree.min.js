...
if(numChildren){o.numChildren=numChildren;o[this.children]=this._objectMapper(a);}
res.push(o);});}
return res;},_getTreeState(uid){if(this.currentState[uid]){return bbn.fn.clone(this.currentState[uid][this.children]);}
