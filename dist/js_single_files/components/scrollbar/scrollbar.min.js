...
this.containerPos=num;this.sliderPos=this.containerPos*this.ratio;if(anim){this.smoothScrollTo(num).then(()=>{resolve();});}
else{this.realContainer['scroll'+(this.isVertical?'Top':'Left')]=num;resolve();}}}});},scrollStart(){this.scrollTo(0);},scrollEnd(){this.scrollTo(this.contentSize-this.containerSize);}},watch:{isOverSlider(v){if(!this.dragging){if(!v){this.overContent();}
