((bbn)=>{let script_dep=document.createElement('script');script_dep.setAttribute('src',"https://cdn.jsdelivr.net/combine/gh/jaames/iro.js@5.0.0/iro.js,gh/jaames/iro.js@5.0.0/plugins/iro-transparency-plugin/1.0.2/iro-transparency-plugin.js");script_dep.onload=()=>{let script=document.createElement('script');script.innerHTML=`<span :class="['bbn-iblock', componentClass, {'bbn-disabled': !!disabled}]">
  <input :value="value"
...
else if(!this.disabled&&!this.readonly){this.showFloater=true;}}},mounted(){this.ready=true;},beforeDestroy(){this.destroy();}});})(bbn);};document.head.insertAdjacentElement("beforeend",script_dep);})(bbn);