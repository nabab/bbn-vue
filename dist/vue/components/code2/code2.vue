    ...
    mounted(){
      ...
      if (el){
        let state = CodeMirror.EditorState.create({
          ...
          */
          extensions: [
            CodeMirror.ViewPlugin.fromClass(class {
              constructor(view) {}
  
              update(update) {
                if (update.docChanged) {
                  let v = update.state.doc.toString();
                  cp.emitInput(v);
                  bbn.fn.log("CHANGE", update, v)
            ...
            CodeMirror.history(),
            CodeMirror.foldGutter(),
            CodeMirror.multipleSelections(),
            CodeMirror.defaultHighlighter,
            ...
            CodeMirror.keymap([
              ...
              ...CodeMirror.foldKeymap,
              ...CodeMirror.commentKeymap,
              ...CodeMirror.gotoLineKeymap,
              ...CodeMirror.autocompleteKeymap,
              ...CodeMirror.lintKeymap
            ])
            */
            CodeMirror.basicSetup,
        ...
        this.widget = new CodeMirror.EditorView({
          parent: el,
          /*
          dispatch: update => {
            bbn.fn.log("UPDATE2", update);
            return true
...
.bbn-code2 .bbn-code-filled {
  width: 100%;
  min-height: 100%;
}
.bbn-code2 .bbn-code-filled .CodeMirror {
  width: 100%;
  height: auto;
  top: 0;
  left: 0;
...
.bbn-code2 .bbn-code-filled .CodeMirror::-webkit-scrollbar {
  display: none;
}
.bbn-code2 .bbn-code-filled .CodeMirror .CodeMirror-vscrollbar,
.bbn-code2 .bbn-code-filled .CodeMirror .CodeMirror-hscrollbar {
  display: none !important;
}
.bbn-code2 .bbn-code-filled .CodeMirror .CodeMirror-scroll {
  margin: 0px;
  padding: 0px;
}
.bbn-code2 .theme-button {
  position: absolute;
  width: 25px;
  height: 25px;
  z-index: 5;
}
.bbn-code2 .bbn-scrollbar {
  z-index: 6;
}
