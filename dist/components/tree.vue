      ...
      >
        ...
        >
          <li :class="['bbn-tree-node', 'bbn-unselectable', {
                        'bbn-state-active': (isActive && !isSelected) || (tree.dragging && tree.overNode && !tree.overOrder && (tree.overNode === _self)),
          ...
          >
            ...
            ></span>
            <span :class="'node' + (component ? '' : ' no-component') + (source.cls ? ' ' + source.cls : '')"
                  @mouseover.stop="mouseOver"
            >
...
.bbn-tree .bbn-tree-node span.node {
  display: inline-block;
  white-space: nowrap;
  height: auto;
  min-height: 18px;
}
.bbn-tree .bbn-tree-node span.node.dropping {
  background-color: green;
  color: white;
}
.bbn-tree .bbn-tree-node span.node.no-component span {
  display: inline-block;
}
.bbn-tree .bbn-tree-node span.node.no-component .selectable {
  cursor: pointer;
  padding: 1px;
}
.bbn-tree .bbn-tree-node span.node.no-component .expander {
  width: 0.7em;
  padding-left: 0.2em;
  font-size: 1.1em;
  cursor: pointer;
}
.bbn-tree .bbn-tree-node span.node.no-component .icon {
  width: 1.3em;
}
.bbn-tree .bbn-tree-node span.node.no-component .icon.with-zoom {
  zoom: 1.1;
}
.bbn-tree .bbn-tree-node span.node.no-component .title {
  white-space: nowrap;
}
.bbn-tree .bbn-tree-node.selected > span.node > span > span.selectable {
  border: 1px solid blue;
  padding: 0;
  background-color: blue;
  color: white;
}
.bbn-tree .bbn-tree-node.active > span.node > span > span.selectable {
