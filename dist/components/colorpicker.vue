    ...
    <bbn-splitter orientation="horizontal">
      <bbn-pane>
        <div class="bbn-overlay bbn-middle">
          ...
          ></div>
          <bbn-scroll v-if="showPalette" class="bbn-background">
...
<script>
  module.exports = //* This component allows you to create an intuitive interface for color manipulations
...
<style scoped>
.bbn-colorpicker .bbn-colorpicker-input-hidden {
  display: none;
}
